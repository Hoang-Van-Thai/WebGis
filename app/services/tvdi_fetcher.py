...
#     startDate = endDate.advance(-20, "month")
#
#     # MODIS NDVI
#     ndvi = (
...
#         e = s.advance(1, "month")
#         img = ndvi.filterDate(s, e).mean().addBands(
#               lst.filterDate(s, e).mean()
#         ).set("system:time_start", s.millis()).set("date", s.format("YYYY-MM"))
#         return img
#
...
#
#         tvdi = ls.subtract(lst_min).divide(lst_max.subtract(lst_min)).rename("TVDI")
#         return tvdi.set("date", img.get("date")).set("system:time_start", img.get("system:time_start"))
#
