# # app/services/lst_auto_predict.py
# import numpy as np
# import pandas as pd
# from app.services.lst_service import model, scalers
#
# def lst_predict_next_7_weeks(xa):
#     df = pd.read_csv("lst_weekly_interpolated.csv")
...
#
#         # Update the sequence: shift left + add new pred
...
#     ]
# def lst_history_with_forecast(xa):
...
def _load_lst_df_from_mongo(xa: str) -> pd.DataFrame:
    """
    Lấy LST theo xã từ Mongo, sort theo date, nội suy theo thời gian.
    Trả về DataFrame có cột: ten_xa, date, LST_K
    """
    docs = list(
