...
//  };
//})();
// app.js (FULL) - HIỂN THỊ NGÀY DỰ BÁO = HÔM NAY + NGÀY TIẾP THEO (daily)
// Không train lại model, không đổi logic gọi API / map / chart của bạn.
// Chỉ đổi nhãn ngày hiển thị: LST/NDVI/TVDI đều +1, +2, +3... theo ngày.
...
//
//// ===================== FORECAST GRID =====================
//// ✅ HIỂN THỊ NGÀY = hôm nay + 1, +2, +3... cho tất cả model
//function renderForecastGrid(data) {
//  const grid = document.getElementById("forecastGrid");
//  if (!grid) return;
//  grid.innerHTML = "";
...
//
//      // ✅ daily
//      const date = _addDays(baseToday, i + 1);
//
...
//
//      // ✅ daily
//      const dateObj = _addDays(baseToday, i + 1);
//
...
//
//// ===================== CHART =====================
//// ✅ DỰ BÁO trên chart cũng hiển thị ngày = hôm nay + 1, +2, +3...
//function renderChart(data) {
//  const canvas = document.getElementById("chartCanvas");
//  if (!canvas) return;
//
...
//    const d = _addDays(baseToday, i + 1);
